...
export const validateSchemaForm = yup.object().shape({
  full_name: yup.string().required('El nombre es requerido').min(10, 'El nombre debe tener al menos 10 caracteres').max(50, 'El nombre debe tener máximo 50 caracteres'),
